...
bool Utils::GetAddresses(DWORD_PTR Address, const char* buffer, DWORD Size)
{
	...
	{
		Utils::Fmt::PrintMessage("Hata UWorldState!\n");
	}
	...
	{
		Utils::Fmt::PrintMessage("Hata OwningGameInstance!\n");
	}
	...
	{
		Utils::Fmt::PrintMessage("Hata LocalPlayers!\n");
	}
	...
	{
		Utils::Fmt::PrintMessage("Hata LocalPawn!\n");
	}
	...
	{
		Utils::Fmt::PrintMessage("Hata RootComponent!\n");
	}
	...
	{
		Utils::Fmt::PrintMessage("Hata RootPosition!\n");
	}
	...
	{
		Utils::Fmt::PrintMessage("Hata CameraPosition!\n");
	}
	...
	{
		Utils::Fmt::PrintMessage("Hata CameraRotation!\n");
	}
